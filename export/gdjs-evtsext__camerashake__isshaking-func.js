...
gdjs.evtsExt__CameraShake__IsShaking.condition0IsTrue_0.val = false;
{
gdjs.evtsExt__CameraShake__IsShaking.condition0IsTrue_0.val = gdjs.evtTools.variable.getVariableNumber(runtimeScene.getGame().getVariables().get("__CameraShake_ShakeInProgress")) == 1;
